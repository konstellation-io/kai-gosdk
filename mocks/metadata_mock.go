...
// GetEphemeralStorageName provides a mock function with no fields
func (_m *MetadataMock) GetEphemeralStorageName() string {
	ret := _m.Called()

	if len(ret) == 0 {
		panic("no return value specified for GetEphemeralStorageName")
	}
...
// GetGlobalCentralizedConfigurationName provides a mock function with no fields
func (_m *MetadataMock) GetGlobalCentralizedConfigurationName() string {
	ret := _m.Called()

	if len(ret) == 0 {
		panic("no return value specified for GetGlobalCentralizedConfigurationName")
	}
...
// GetProcessCentralizedConfigurationName provides a mock function with no fields
func (_m *MetadataMock) GetProcessCentralizedConfigurationName() string {
	ret := _m.Called()

	if len(ret) == 0 {
		panic("no return value specified for GetProcessCentralizedConfigurationName")
	}
...
// GetProcessType provides a mock function with no fields
func (_m *MetadataMock) GetProcessType() string {
	ret := _m.Called()

	if len(ret) == 0 {
		panic("no return value specified for GetProcessType")
	}
...
// GetProductCentralizedConfigurationName provides a mock function with no fields
func (_m *MetadataMock) GetProductCentralizedConfigurationName() string {
	ret := _m.Called()

	if len(ret) == 0 {
		panic("no return value specified for GetProductCentralizedConfigurationName")
	}
...
// GetWorkflow provides a mock function with no fields
...
// GetWorkflowCentralizedConfigurationName provides a mock function with no fields
func (_m *MetadataMock) GetWorkflowCentralizedConfigurationName() string {
	ret := _m.Called()

	if len(ret) == 0 {
		panic("no return value specified for GetWorkflowCentralizedConfigurationName")
	}
...
// GetWorkflowType provides a mock function with no fields
func (_m *MetadataMock) GetWorkflowType() string {
	ret := _m.Called()

	if len(ret) == 0 {
		panic("no return value specified for GetWorkflowType")
	}
